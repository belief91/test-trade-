...
const COLS = ["", "Date · Heure", "Paire", "Sens", "Setup", ""];
...
export default function TradeList() {
  ...
  return (
    <div className="card">
      <div style={{ display: "grid", gridTemplateColumns: "4px 104px 76px 60px 1fr 32px", gap: 12, padding: "8px 16px", borderBottom: "1px solid var(--border)" }}>
        {COLS.map((col, i) => (
