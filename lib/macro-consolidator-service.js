...
//
// FIX : le require pointait vers "../config/macro-knowledge-base.json"
// alors que le fichier réel s'appelle
// "config/config_macro-knowledge-base.json" (préfixe "config_" en trop
// par rapport à ce que le code attendait). Cause exacte de l'erreur de
// build "Module not found: Can't resolve '../config/macro-knowledge-base.json'"
// une fois ce fichier réellement importé par app/api/central-bank-calendar/route.js.
//
...
const KNOWLEDGE_BASE = require("../config/config_macro-knowledge-base.json");
