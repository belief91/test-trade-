...
//
// FIX (25/09) : import de "./central-bank-keywords" -> "./central-bank-keywords.js".
// Sans extension, Next.js resout correctement (bundler tolerant), mais
// un script Node autonome (node scripts/test-filtre-trap-words.js)
// echoue avec ERR_MODULE_NOT_FOUND - meme piege deja rencontre plusieurs
// fois cette session sur d'autres fichiers (r2-client.js, back4app-server.js).

import { MONETARY_KEYWORDS, BANK_SPECIFIC_KEYWORDS, TRAP_WORDS } from "./central-bank-keywords.js";
