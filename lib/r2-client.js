...
// Instantané journalier, utilisé par la fusion IA — n'est pas pensé comme
// un historique permanent (peut être écrasé/nettoyé un jour si besoin).
...
// Génère une clé database/{module}/{date}.json — ARCHIVE PERMANENTE,
// distincte de raw/{date}/{module}.json. Un fichier par jour, jamais
// écrasé par un autre jour, jamais supprimé automatiquement. Sert de
// backup durable en plus de Back4App (qui reste la source interrogeable
// par le consolidateur macro).
